...
\- /STRING : /STRING ( c-addr1 u n -- c-addr2 u2 ) \ 94 STRING
\- /STRING  ( OVER MIN ) >R R@ - SWAP R> CHARS + SWAP ;
[IFNDEF] SCAN
...
FLOAD color.4th 
REQUIRE EXKEY ext/exkey.4th
REQUIRE CASE ext/case.4th 
FLOAD tools/acc.4th  CO
REQUIRE NC tools/NNC.4th 
REQUIRE EDIT tools/view.4th 
FLOAD ./ForthLib/tools/dir.4th 

 LASTSTP: : KEYTST BEGIN KEY DUP h. BL = UNTIL ; KEYTST
 LASTSTP: DIR
 LASTSTP: WORDS
 LASTSTP: VIEW-MAX-POINT @ H.
 LASTSTP: NC
